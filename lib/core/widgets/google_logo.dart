...
/// A pure vector Flutter widget that renders the official 4-color Google "G" logo
/// without network dependencies, CORS issues, or external assets.
...
class _GoogleLogoPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // 3. Yellow: Lower-left arc (#FBBC05)
